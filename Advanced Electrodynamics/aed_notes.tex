...
\input{/home/fran/Templates/LatexTemplates/TeXtured-master/preamble/pdfA-compliance/glyphtounicode}
...
\input{/home/fran/Templates/LatexTemplates/TeXtured-master/preamble/main}
...
\def\Title{Advanced Electrodynamics}
\def\Subtitle{}
\def\Author{Fran \v{S}timac}
\definecolor{MainColor}{HTML}{3C8031} % Define the new main color

%%% Get the current year dynamically %%%
\newdateformat{myyear}{\the\year}
\def\CurrentYear{\myyear\today}
...
\frontmatter
\include{chapters/frontmatter/title.tex}
